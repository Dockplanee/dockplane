 ...
 *
 * The document ships without a `data-theme` attribute so the operating system
 * preference applies through a media query. A stored preference is re-applied
 * by public/initial-theme.js before first paint; this service keeps the in-page
 * state in sync once Angular takes over.
 */
